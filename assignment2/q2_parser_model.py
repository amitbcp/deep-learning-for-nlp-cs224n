...
class ParserModel(Model):
    ...
    def add_loss_op(self, pred):
        ...
        """
        ### YOUR CODE HERE
        predictions = tf.nn.softmax_cross_entropy_with_logits(logits=pred,labels=self.labels_placeholder)
    ...
    def add_training_op(self, loss):
        ...
        """
        ### YOUR CODE HERE
        optimezer = tf.train.AdamOptimizer()
