...
def softmaxCostAndGradient(predicted, target, outputVectors, dataset):
    ...
    #grad2 = np.dot(delta.reshape(V,1),predicted.reshape(1,N))
    ...
    #print("Checking the different implementation :: ")
    #assert grad== grad2
...
def negSamplingCostAndGradient(predicted, target, outputVectors, dataset,K=10):
    ...
    #print("Indices List in Negative Sampling {}".format(indices))
...
def skipgram(currentWord, C, contextWords, tokens, inputVectors, outputVectors,
    ...
    ##Input word Vector of the Center Word
...
def test_word2vec():
    ...
    def getRandomContext(C):
        ...
        return tokens[random.randint(0,4)], \
            [tokens[random.randint(0,4)] for i in list(range(2*C))]
    ...
    print("\n=== Results ===")
    print("Skipgram with Softmax Gradient Descent....................")
    print(skipgram("c", 3, ["a", "b", "e", "d", "b", "c"],dummy_tokens, dummy_vectors[:5,:], dummy_vectors[5:,:], dataset))
    print("Skipgram Model with Negative Sampling...................")
    print(skipgram("c", 1, ["a", "b"],dummy_tokens, dummy_vectors[:5,:], dummy_vectors[5:,:], dataset,negSamplingCostAndGradient))
    print("CBOW with Softmax Gradient Descent....................")
    print(cbow("a", 2, ["a", "b", "c", "a"],dummy_tokens, dummy_vectors[:5,:], dummy_vectors[5:,:], dataset))
    print("CBOW Model with Negative Sampling...................")
